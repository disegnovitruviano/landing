...
"retina_detect": true
  ...
  $('.navigation .navbar-collapse').prepend('<button id="fs-navbar-closer"></button>');
  $(document).on('click', '#fs-navbar-closer', function(e){
    $('.navigation .navbar-collapse').removeClass('in');
